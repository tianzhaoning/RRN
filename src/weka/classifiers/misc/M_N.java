...
public class M_N extends SingleClassifierEnhancer implements OptionHandler, WeightedInstancesHandler {
	...
	public static void main(String[] argv) {
		...
		try {
			System.out.println(Evaluation.evaluateModel(new M_N(), argv));
